        ...
        {!isFinished ? (
          <>
            ...
            <div className="mt-3 flex justify-between text-sm">
              <span className="text-text-secondary truncate max-w-[70%]">{status}</span>
          ...
          <div className="mt-4 space-y-4">
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-green-500">{result.successCount}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-text-secondary">Skipped:</span>
                <span className="font-medium text-yellow-500">{result.skippedCount}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-text-secondary">Failed:</span>
                <span className="font-medium text-red-500">{result.failedCount}</span>
              </div>
            </div>
